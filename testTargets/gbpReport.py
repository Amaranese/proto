...
THIS JOB CONNECTS TO COINMARKET CAP, AND PULLS DOWN PRICE DATA FOR EACH COIN AND SAVES TO REPORTS FOLDER
...
selectedCoins = ["BTC", "DOGE", "LTC", "ETH", "ETN", "USDT", "DASH", "ZEC", "XRP", "BTG", "QTUM", "XEM"]
